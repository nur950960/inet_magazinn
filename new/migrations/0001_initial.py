# Generated by Django 3.1 on 2024-04-24 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='new.author')),
                ('genre', models.ManyToManyField(to='new.Genre')),
            ],
        ),
    ]
